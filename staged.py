...
imageObject = Image.open("/home/wolf/animated-decal/assets/greymon-scaled.gif")
...
def extractFrames(inGif, outFolder):
    ...
    nframes = 0
    while frame:
        frame.save( '%s/%s-%s.jpg' % (outFolder, os.path.basename(inGif), nframes ) , 'JPEG')
        nframes += 1
        try:
            frame.seek( nframes )
        except EOFError:
...
try:
    ...
    draw.text((5, 68), 'NIGGA', fill = "BLACK",font=Font1)
    draw.rectangle([(0,115),(190,160)],fill = "RED")
    draw.text((5, 118), 'NIGGA', fill = "WHITE",font=Font2)
    draw.text((5, 160), '12345678NIGA', fill = "GREEN",font=Font3)
    text= u"HUH WHAT?"
    ...
    for frame in range(0,imageObject.n_frames):
        ...
        disp.ShowImage(imageObject.show())
    #image = Image.open('/home/wolf/animated-decal/assets/greymon-scaled.gif')
    #image = image.rotate(180)
    # extractFrames('/home/wolf/animated-decal/assets/greymon-scaled.gif','/home/wolf/animated-decal/tmp')
